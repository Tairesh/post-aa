...
init -1 python hide:
    ...
    config.window_title = u"After Armagedon"
...
python early:
    config.save_directory = "postaa-1524658857"
...
init python:
    ...
    build.directory_name = "postaa-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "postaa"
